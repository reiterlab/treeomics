...
from treeomics.phylogeny.max_lh_phylogeny import MaxLHPhylogeny
from treeomics.utils.mutation_matrix import write_mutation_matrix
from treeomics.utils.data_tables import write_mutation_patterns
import treeomics.plots.tikz_tree as tikz
import treeomics.utils.latex_output as latex
...
def _create_tree_plots(solution, mlh_pg, mlh_tree, plots, tikztrees, tree_filepath, driver_vars, variant_filepath=None):
    ...
    if tree_filepath is not None:
        ...
        if plots:
            try:
                # create ETE tree
                from treeomics.plots.ete_tree import create_tree
